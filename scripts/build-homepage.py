...
<main id="main">
  ...
  <section class="entries" aria-labelledby="entriesTitle">
    <div class="entries-bed" aria-hidden="true">
      <img src="{hero}" alt="" width="1600" height="900" loading="lazy" decoding="async">
    </div>
    <div class="entries-inner">
      <div class="entries-head">
        <h2 id="entriesTitle" class="stage-label">Start here</h2>
        <p>Four ways into Masinloc.</p>
      </div>
      <ul class="door-grid">
        <li class="door rise" style="--accent:var(--blue)"><a href="destinations.html">
          ...
          <span class="d-name">Places</span>
          <span class="d-what">Eight places on this coast, photographed where they actually are.</span>
          <span class="d-go" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M13 7l5 5-5 5"/></svg></span>
        </a></li>
        <li class="door rise" style="--accent:var(--yellow);--on-accent:var(--navy-deep);--delay:80ms"><a href="sambal-tina.html">
          ...
          <span class="d-name">Culture &amp; Sambal&nbsp;Tina</span>
          <span class="d-what">{n['total']:,} dictionary entries, and the language Masinloc still speaks.</span>
          <span class="d-go" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M13 7l5 5-5 5"/></svg></span>
        </a></li>
        <li class="door rise" style="--accent:var(--red);--delay:160ms"><a href="connect.html">
          <span class="d-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 9.5h16"/><path d="M5.2 9.5 6.8 4.5h10.4l1.6 5"/><path d="M5.5 9.5V19a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V9.5"/><path d="M10 20v-4.6h4V20"/></svg></span>
          <span class="d-name">Local Businesses</span>
          <span class="d-what">Masinloqueño trade, added to the record by the people who run it.</span>
          <span class="d-go" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M13 7l5 5-5 5"/></svg></span>
        </a></li>
        <li class="door rise" style="--accent:var(--blue-bright);--delay:240ms"><a href="connect.html">
          ...
          <span class="d-what">Opportunities, services and community updates in one platform.</span>
          <span class="d-go" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M13 7l5 5-5 5"/></svg></span>
        </a></li>
      </ul>
    </div>
