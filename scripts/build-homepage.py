...
<main id="main">
  ...
  <section class="entries" aria-labelledby="entriesTitle">
    <div class="entries-inner">
      ...
      <ul class="door-grid">
        <li class="door door-blue rise"><a href="destinations.html">
        ...
        <li class="door door-red rise" style="--delay:160ms"><a href="masinloc-bulletin.html">
          ...
          <span class="d-name">History &amp; Stories</span>
          <span class="d-what">How Masinloc's history has been told, and what the evidence supports.</span>
          <span class="d-go" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h13M13 7l5 5-5 5"/></svg></span>
        </a></li>
        <li class="door door-white rise" style="--delay:240ms"><a href="connect.html">
